<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LitVertical.aspx.cs" Inherits="LitVertical" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GotoNature(sVer) {
            $(window).attr("location", "LitPage.aspx?Vertical=" + sVer + "|ISViews=" + GetQueryStringParams("ISViews"));
        }
        ...
        <div id="wrapper">
            <div id="centerWrapper">
                <div id="tileContainer">
                    ...
                    <a href="#&amp;group-2" id="A3" class="groupTitle" style="margin-left: 0px;
                        margin-top: 0px" onclick="javascript:$group.goTo(0);">
                        <h3>
                            Vertical</h3>
                    </a>
                    <!--- Add Litigation tab Sart -->
                    <a id="tileScroll0_1-1" class="tile tileOrange group1 " onclick="GotoNature('IFS');"
                        style="margin-top: 45px; margin-left: 0px; width: 300px; height: 145px;" data-pos='45-0-300'>
                        <div class="BigIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/coworkers.png" height="80" width="80" />
                        </div>
                 ...
                 <a class="tile tileCrim group1 " id="aAdvocate" onclick="GotoNature('SDB');" href="javascript:void(0);"
                        ...
                        <div class="BigIcon">
                            <img title='' alt='' src="Dtop/img/Content/coworkers.png" height="80"
                                width="80" />
                        </div>
                    </a>

                    <a class="tile tileSky group1 " id="firmTile" onclick="GotoNature('MPIL');" href="javascript:void(0);"
                    ...
                    <a class="tile tileGrey group1 " id="aClient" onclick="GotoNature('Support')" href="javascript:void(0);"
                   ...
                   <a class="tile tileFlipText tileGreen group1 " id="addrBook" onclick="GotoNature('Innovative');"
