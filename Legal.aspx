        ...
        <div id="wrapper">
            <div id="centerWrapper">
                <div id="tileContainer">
                 ...
                 <a class="tile tileCrim group1 " id="aAdvocate" onclick="OpenUrl(this);" href="javascript:void(0);"
                    ...
                    <a class="tile tileSky group1 " id="firmTile" onclick="OpenUrl(this);" href="javascript:void(0);"
                    ...
                    <a class="tile tileSky group1 " id="aClient" onclick="OpenUrl(this);" href="javascript:void(0);"
                        ...
                        <div class="SmallIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/businessman146.png" height="80" width="80" />
                        </div>
                        <div class='tileTitleBottom' style='margin-left: 10px; z-index: 11;'>
                            Client Views
                        </div>
                   ...
                   <a class="tile tileFlipText tileGreen group1 " id="addrBook" onclick="OpenUrl(this);"
