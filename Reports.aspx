    ...
    <script type="text/javascript">
        ...
        function OpenReportsDialog(Id) {
            ...
            $.nsWindow.open({
                ...
                width: 800,
                height: 620,
                dataUrl: 'frmReports.aspx?ReportId=' + Id,
        ...
        <div id="wrapper">
            <div id="centerWrapper">
                <div id="tileContainer">
                    ...
                    <a class="tile tileGreen group2 " id="A4" onclick="OpenReportsDialog(1);" href="javascript:void(0);"
                    ...
                    </a><a class="tile tileOrange group2 " id="A8" onclick="OpenReportsDialog(2);" href="javascript:void(0);"
                        style="margin-top: 45px; margin-left: 310px; width: 300px; height: 145px;" data-pos='45-310-300'>
                        <div class='tileTitleTop' style='margin-left: 10px; z-index: 11;'>
                            Amount</div>
                        <div class="BigIcon" style="margin-top: 0px;">
                            <img title='' alt='' src="Dtop/img/Content/Projection.png" height="80" width="80" />
                        </div>
                    </a><a class="tile tilePurple group2 " id="a3" onclick="OpenReportsDialog(3);" href="javascript:void(0);"
                        style="margin-top: 200px; margin-left: 0px; width: 300px; height: 145px;" data-pos='45-0-300'>
                        <div class="BigIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/Pbook-old.png" height="80" width="80" />
                        </div>
                        <div class='tileTitleBottom' style='margin-left: 10px; z-index: 11;'>
                            Vertical
                        </div>
                    </a><a class="tile tileCrim group2 " id="A5" onclick="OpenReportsDialog(4);" href="javascript:void(0);"
                        style="margin-top: 200px; margin-left: 310px; width: 145px; height: 145px;" data-pos='200-310-145'>
                        <div class='tileTitleTop' style='margin-left: 10px; z-index: 11;'>
                            CASES ADDED/CLOSED</div>
                        <div class="SmallIcon" style="margin-top: 0px;">
                            <img title='' alt='' src="Dtop/img/Content/Reports1.png" height="80" width="80" />
                        </div>
                    </a><a class="tile tileBlue group2 " id="aMIS" onclick="OpenUrl(this);" href="javascript:void(0);"
                        style="margin-top: 200px; margin-left: 465px; width: 145px; height: 145px;" data-pos='200-465-300'>
                        <div class='tileTitleTop' style='margin-left: 10px; z-index: 11;'>
                            MIS</div>
                        <div class="SmallIcon" style="margin-top: 0px;">
                            <img title='' alt='' src="Dtop/img/Content/Workflow.png" height="80" width="80" />
                        </div>
                    </a>
