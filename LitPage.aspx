<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LitPage.aspx.cs" Inherits="LitPage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GotoVertical() {
            $(window).attr("location", "LitVertical.aspx?ISViews=" + GetQueryStringParams('ISViews'));
        }
        ...
        function OpenLITsDialog(Id) {
            var sVertical = GetQueryStringParams('Vertical');
            $.nsWindow.open({
                title: 'MIS View',
                width: 800,
                height: 620,
                dataUrl: 'MIS_View.aspx?NatureId=' + Id + "|ISViews=" + GetQueryStringParams('ISViews') + "_false|Vertical=" + sVertical,
	        ...
	        <div id="headerWrapper">
		        <div id="headerCenter">
			        <div id="headerTitles" onclick="javascript:location.reload();" style="height: 80px">
                        ...
                        <a id="A5" runat="server" style="width:130px" class="PPLegend">
	                        User
                         </a>               
                         <h2><i><b></b></i></h2>             
		            </div>
		            <nav>
                        ...
                        <a id="group0" style="width:130px" onclick="javascript:GotoHome();">
                         ...
                         <a id="A3" style="width:130px" onclick="javascript:GotoVertical();">
	                        <img src="Dtop/img/Content/businessman157.png" alt="Reports/Views"/>
	                      Vertical
                         </a>                                              
        ...
        <div id="wrapper">
            <div id="centerWrapper">
                <div id="tileContainer">
                    ...
                    <a id="tileScroll0_1-1" class="tile tileOrange group1 " onclick="OpenLITsDialog(1);"
                        style="margin-top: 45px; margin-left: 0px; width: 300px; height: 145px;" data-pos='45-0-300'>
                        <div class="BigIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80" width="80" />
                        </div>
                 ...
                 <a class="tile tileCrim group1 " id="aAdvocate" onclick="OpenLITsDialog(6);" href="javascript:void(0);"
                        ...
                        <div class="BigIcon">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80"
                                width="80" />
                        </div>
                    </a>

                    <a class="tile tileSky group1 " id="firmTile" onclick="OpenLITsDialog(3);" href="javascript:void(0);"
                        style="margin-top: 200px; margin-left: 0px; width: 300px; height: 145px;" data-pos='200-300-145'>
                        <div class="BigIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80" width="80" />
                        </div>
                        <div class='tileTitleBottom' style='margin-left: 10px; z-index: 11;'>
                    ...
                    <a class="tile tileGrey group1 " id="aClient" onclick="OpenLITsDialog(2)" href="javascript:void(0);"
                        style="margin-top: 200px; margin-left: 310px; width: 145px; height: 145px;" data-pos='200-310-145'>
                   ...
                   <a class="tile tileFlipText tileGreen group1 " id="addrBook" onclick="OpenLITsDialog(5);"
                        href="javascript:void(0);" style="margin-top: 200px; margin-left: 465px; width: 145px;
                        height: 145px;" data-pos='200-465-145'>
                        <div class="SmallIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80"
                                width="80" />
                        </div>
                    ...
                    <a class="tile tileFlipText tilePurple group1 " id="a1" onclick="OpenLITsDialog(4);"
                        href="javascript:void(0);" style="margin-top: 45px; margin-left: 620px; width: 145px;
                        height: 145px;" data-pos='45-620-145'>
                        <div class="SmallIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80"
                                width="80" />
                        </div>
                    ...
                    </a><a class="tile tileFlipText tileVoilet group1 " id="a2" onclick="OpenLITsDialog(7);"
                        href="javascript:void(0);" style="margin-top: 200px; margin-left: 620px; width: 145px;
                        height: 145px;" data-pos='200-620-145'>
                        <div class="SmallIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80"
                                width="80" />
                        </div>
                    ...
                    <a class="tile tileFlipText tileGreen group1 " id="a4" onclick="OpenLITsDialog(5);"
                        href="javascript:void(0);" style="margin-top: 200px; margin-left: 465px; width: 145px;
                        height: 145px;" data-pos='200-465-145'>
                        <div class="SmallIcon" style="margin-top: 25px;">
                            <img title='' alt='' src="Dtop/img/Content/drafting1.png" height="80"
