<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFirmView.aspx.cs" Inherits="frmFirmView" %>
      ...
      <div class="example" >
        <fieldset class="PPFieldset">
            ...
            <div style="width: 100%; height: 405px">
                ...
                <input id="btnOk" type="button" class="button success" value="New Firm" onclick="New()" />
                <input id="btnDelete" type="button" class="button success" value="Delete Firm"
                    onclick="DeleteFirm()" />
        ...
        <script type="text/javascript">
            ...
            function BindData() {
                jQuery("#grdFirm").jqGrid({
                    datatype: "local",
                    colNames: ['Name', 'Address', 'City', 'State', 'Mobile No', 'ID'],
                    colModel: [
                     ...
                     { name: 'mobile', index: 'mobile', width: 80, align: "right" },
                      { name: 'FirmId', index: 'FirmId', width: 80, hidden: true, align: "right" }
            ...
            function DeleteFirm() {
                ...
                $.each(RowIds, function (i, data) {
                    ...
                    if (ids == "") {
                        ...
                        ids = ids + RowData.FirmId + "@";
                    }
                });
                $.ajax({
                    type: "POST",
                    url: "frmFirmView.aspx/DeleteData",
                    data: "{cIds :'" + ids + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
