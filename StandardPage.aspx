<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardPage.aspx.cs" Inherits="StandardPage" %>
...
//        function GotoDrafts(sVer) {
//            $(window).attr("location", "LitPage.aspx?Vertical=" + sVer + "|ISViews=" + GetQueryStringParams("ISViews"));
//        }

        function GotoDrafts(Id) {
            $.nsWindow.open({
                title: '',
                width: 700,
                height: 540,
                dataUrl: 'StandardDraft.aspx?ISViews=' + GetQueryStringParams("ISViews") + "|IsType=" + Id,
        ...
        <div id="wrapper">
            <div id="centerWrapper">
                <div id="tileContainer">
                    ...
                    <a id="tileScroll0_1-1" class="tile tileOrange group1 " onclick="GotoDrafts(1);"
                 ...
                 <a class="tile tileCrim group1 " id="aAdvocate" onclick="GotoDrafts(2);" href="javascript:void(0);"
                        ...
                        <div class="BigIcon">
                            <img title='' alt='' src="Dtop/img/Content/aboutus.png" height="80"
                                width="80" />
                        </div>
                    </a>

                    <a class="tile tileSky group1 " id="firmTile" onclick="GotoDrafts(3);" href="javascript:void(0);"
