<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDocs.aspx.cs" Inherits="frmDocs" %>
...
<body class="metro">
    ...
    <script type="text/javascript">
        $(document).ready(function () {           
            ...
            $("#hdnMisId")[0].value = window.location.search.substring(1).split('_')[2];
        });
        ...
        function Closethis() {
            var UpdateDoc = $(parent.document).find('#MisDetails').find('#iHold').contents().find('#btnUpdateDoc');
            UpdateDoc.click();
